...
import { Injectable, Component, InjectionToken, NgModule, ChangeDetectionStrategy, Input, Inject } from '@angular/core';
...
AnalysisGraphComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0, type: AnalysisGraphComponent, deps: [{ token: UserAnalysisResource }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
AnalysisGraphComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.7", type: AnalysisGraphComponent, selector: "fit-analysis-graph", inputs: { uid: "uid", type: "type", showSpinner: "showSpinner" }, usesOnChanges: true, ngImport: i0, template: "<fit-spinner *ngIf=\"isLoading && showSpinner\"></fit-spinner>\n<ng-container *ngIf=\"!isLoading\">\n  <p style=\"text-align: center;\" *ngIf=\"!entries?.length\">\n    Please update some values\n  </p>\n  <div\n    *ngIf=\"entries?.length\"\n    [id]=\"id\"\n    style=\"width: 100%; height: 400px\"\n  ></div>\n</ng-container>\n", components: [{ type: SpinnerComponent, selector: "fit-spinner" }], directives: [{ type: i3.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0, type: AnalysisGraphComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: UserAnalysisResource }, { type: i0.ChangeDetectorRef }]; }, propDecorators: { uid: [{
                type: Input
            }], type: [{
                type: Input
            }], showSpinner: [{
...
PlansResource$1.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0, type: PlansResource$1, deps: [{ token: i1$1.HttpClient }, { token: ngxFiteloConfig }], target: i0.ɵɵFactoryTarget.Injectable });
PlansResource$1.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0, type: PlansResource$1, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0, type: PlansResource$1, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
export { AnalysisGraphComponent, AnalysisGraphModule, CustomOptionsResource, PlansResource as FirestorePlansResource, NgxFiteloComponent, NgxFiteloModule, NgxFiteloService, OauthResource, PaymentsResource, PlansResource$1 as PlansResource, PushNotificationsResource, SpinnerComponent, SpinnerModule, StorageResource, UserAnalysisResource, UserDiaryResource, UserGuidelinesResource, UserNotificationsResource, UserRoutineResource, UsersPaymentResource, WordpressResource, defaultMeasurement, defaultSleep };
