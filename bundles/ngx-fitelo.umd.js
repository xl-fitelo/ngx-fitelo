(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@amcharts/amcharts4/core'), require('@amcharts/amcharts4/charts'), require('@angular/fire/firestore'), require('moment'), require('@angular/common/http'), require('@angular/fire/storage'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-fitelo', ['exports', '@angular/core', '@angular/common', '@amcharts/amcharts4/core', '@amcharts/amcharts4/charts', '@angular/fire/firestore', 'moment', '@angular/common/http', '@angular/fire/storage', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["ngx-fitelo"] = {}, global.ng.core, global.ng.common, global.am4core, global.am4charts, global.ng.fire.firestore, global.moment, global.ng.common.http, global.ng.fire.storage, global.rxjs.operators));
})(this, (function (exports, i0, i3, am4core, am4charts, i1, moment, i1$1, i1$2, operators) { 'use strict';
