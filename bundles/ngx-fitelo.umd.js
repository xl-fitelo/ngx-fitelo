    ...
    ***************************************************************************** */
        ...
        OauthResource.prototype.updateRoutine = function (accessToken, userId, date, mealId, value) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.httpClient.put(url, { mealTaken: value }, { headers: { 'accesstoken': accessToken } }).toPromise()];
                });
            });
        };
    ...
    var PlansResource = /** @class */ (function () {
        ...
        PlansResource.prototype.mget = function (planIds) {
            return __awaiter(this, void 0, void 0, function () {
                var planIdsDict, uPlanIds, dbPlans, chunked, _loop_1, this_1, i, plans;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            planIdsDict = {};
                            planIds.forEach(function (id) { return planIdsDict[id] = 0; });
                            uPlanIds = Object.keys(planIdsDict);
                            dbPlans = [];
                            chunked = chunkArray(uPlanIds, 10);
                            _loop_1 = function (i) {
                                var _b, _c;
                                return __generator(this, function (_d) {
                                    switch (_d.label) {
                                        case 0:
                                            _c = (_b = dbPlans).concat;
                                            return [4 /*yield*/, this_1.firestore.collection('plans', function (q) { return q.where('id', 'in', chunked[i]); }).get().toPromise()];
                                        case 1:
                                            dbPlans = _c.apply(_b, [(_d.sent()).docs.map(function (d) { return d.data(); })]);
                                            return [2 /*return*/];
                                    }
                                });
                            };
                            ...
                            _a.label = 1;
                        case 1:
                            if (!(i < chunked.length)) return [3 /*break*/, 4];
