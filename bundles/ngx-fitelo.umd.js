(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@amcharts/amcharts4/core'), require('@amcharts/amcharts4/charts'), require('@angular/fire/firestore'), require('@angular/common/http'), require('moment'), require('@angular/fire/storage'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-fitelo', ['exports', '@angular/core', '@angular/common', '@amcharts/amcharts4/core', '@amcharts/amcharts4/charts', '@angular/fire/firestore', '@angular/common/http', 'moment', '@angular/fire/storage', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["ngx-fitelo"] = {}, global.ng.core, global.ng.common, global.am4core, global.am4charts, global.ng.fire.firestore, global.ng.common.http, global.moment, global.ng.fire.storage, global.rxjs.operators));
})(this, (function (exports, i0, i3, am4core, am4charts, i1, i1$1, moment, i1$2, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var UserAnalysisResource = /** @class */ (function () {
        ...
        UserAnalysisResource.prototype.findLatestEntry = function (userAnalysis, type) {
            ...
            Object.keys(userAnalysis.data).sort().forEach(function (date) {
    ...
    var AnalysisGraphComponent = /** @class */ (function () {
        function AnalysisGraphComponent(uar, cdr) {
            this.uar = uar;
            this.cdr = cdr;
    ...
    AnalysisGraphComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: AnalysisGraphComponent, deps: [{ token: UserAnalysisResource }, { token: i0__namespace.ChangeDetectorRef }], target: i0__namespace.ɵɵFactoryTarget.Component });
    AnalysisGraphComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.7", type: AnalysisGraphComponent, selector: "fit-analysis-graph", inputs: { uid: "uid", type: "type", showSpinner: "showSpinner" }, usesOnChanges: true, ngImport: i0__namespace, template: "<fit-spinner *ngIf=\"isLoading && showSpinner\"></fit-spinner>\n<ng-container *ngIf=\"!isLoading\">\n  <p style=\"text-align: center;\" *ngIf=\"!entries?.length\">\n    Please update some values\n  </p>\n  <div\n    *ngIf=\"entries?.length\"\n    [id]=\"id\"\n    style=\"width: 100%; height: 400px\"\n  ></div>\n</ng-container>\n", components: [{ type: SpinnerComponent, selector: "fit-spinner" }], directives: [{ type: i3__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }], changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: AnalysisGraphComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: UserAnalysisResource }, { type: i0__namespace.ChangeDetectorRef }]; }, propDecorators: { uid: [{
                    type: i0.Input
                }], type: [{
                    type: i0.Input
                }], showSpinner: [{
    ...
    var OauthResource = /** @class */ (function () {
        ...
        OauthResource.prototype.getUser = function (accessToken) {
            return __awaiter(this, void 0, void 0, function () {
                var ud;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.httpClient.get(this.config.API_URL + "/oauth/self", { headers: { 'accesstoken': accessToken } }).toPromise()];
                        case 1:
                            ud = _a.sent();
                            return [2 /*return*/, ud];
                    }
        ...
        OauthResource.prototype.updateUser = function (accessToken, userDict) {
            return __awaiter(this, void 0, void 0, function () {
                var ud;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.httpClient.post(this.config.API_URL + "/oauth/updateuser", userDict, { headers: { 'accesstoken': accessToken } }).toPromise()];
                        case 1:
                            ud = _a.sent();
                            return [2 /*return*/, ud];
                    }
        ...
        OauthResource.prototype.updateSubscription = function (accessToken, plan, razorpay_payment_id) {
            return __awaiter(this, void 0, void 0, function () {
                var update, ud;
                return __generator(this, function (_a) {
                    update = {
                    ...
                    ud = this.httpClient.put(this.config.API_URL + "/oauth/subscription", update, { headers: { 'accesstoken': accessToken } }).toPromise();
                    return [2 /*return*/, ud];
                });
            });
        };
        OauthResource.prototype.forgotPassword = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.httpClient.post(this.config.API_URL + "/oauth/forgot-password", { email: email }).toPromise()];
                });
            });
        };
        OauthResource.prototype.resetPassword = function (email, code, password) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.httpClient.post(this.config.API_URL + "/oauth/reset-password", { email: email, code: code, password: password }).toPromise()];
                });
            });
        };
        OauthResource.prototype.getRoutine = function (accessToken, id, date) {
            return __awaiter(this, void 0, void 0, function () {
                var data, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.httpClient.get(this.config.API_URL + "/oauth/routines/" + id + "/" + date, { headers: { 'accesstoken': accessToken } }).toPromise()];
                        case 1:
                            data = _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
        ...
        OauthResource.prototype.updateRoutine = function (accessToken, userId, date, mealId, value) {
            return __awaiter(this, void 0, void 0, function () {
                var httpOptions, url;
                return __generator(this, function (_a) {
                    date = moment__default["default"](date).format('YYYY-MM-DD');
                    httpOptions = {
                    ...
                    url = this.config.API_URL + "/oauth/routines/" + userId + "/" + date + "/mealtaken/" + mealId;
                    return [2 /*return*/, this.httpClient.put(url, value, httpOptions).toPromise()];
                });
            });
        };
        OauthResource.prototype.getGroceries = function (accessToken, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var fiterparam, res, routine, newgroceriesDict;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fiterparam = new i1$1.HttpParams().set('filters', JSON.stringify(this.getFilersArray()));
                            return [4 /*yield*/, this.httpClient.get(this.config.API_URL + "/oauth/routines/" + userId, { params: fiterparam, headers: { 'accesstoken': accessToken } }).toPromise()];
                        case 1:
                            res = _a.sent();
                            routine = res.data;
                            newgroceriesDict = {};
                            routine.forEach(function (val) {
                                val.mealDicts.forEach(function (meal) {
                                    meal.recipeDicts.forEach(function (recipe) {
                                        if (recipe.groceryDicts) {
                                            recipe.groceryDicts.forEach(function (grocery) {
                            ...
                            return [2 /*return*/, Object.values(newgroceriesDict)];
                    }
                });
            });
        };
        OauthResource.prototype.getFilersArray = function () {
            var today = moment__default["default"]().format("YYYYMMDD");
            var filersArray = [
                {
                    "field": "date",
                    "operator": ">=",
                ...
                },
                {
                    "field": "date",
                    "operator": "<=",
                    "value": moment__default["default"]().add(7, 'day').format("YYYYMMDD")
                }
            ];
            return filersArray;
        };
    ...
    var PlansResource$1 = /** @class */ (function () {
        function PlansResource(http, config) {
            this.http = http;
            this.config = config;
        }
        PlansResource.prototype.getPlans = function () {
            var url = this.config.API_URL + "/plans";
            return this.http.get(url).toPromise();
        };
        return PlansResource;
    }());
    PlansResource$1.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PlansResource$1, deps: [{ token: i1__namespace$1.HttpClient }, { token: ngxFiteloConfig }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    PlansResource$1.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PlansResource$1, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PlansResource$1, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    var UserRoutineResource = /** @class */ (function () {
        function UserRoutineResource(config, http) {
            this.config = config;
            this.http = http;
        }
        UserRoutineResource.prototype.getRoutine = function (id, date) {
            return __awaiter(this, void 0, void 0, function () {
                var data, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.http.get(this.config.API_URL + "/users/" + id + "/routines/" + date).toPromise()];
                        case 1:
                            data = _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
        ...
        UserRoutineResource.prototype.updateRoutine = function (id, date, mealId, value) {
            return __awaiter(this, void 0, void 0, function () {
                var payload, httpOptions, url;
                return __generator(this, function (_a) {
                    payload = value;
                    date = moment__default["default"](date).format('YYYY-MM-DD');
                    httpOptions = {
                    ...
                    url = this.config.API_URL + "/users/" + id + "/routines/" + date + "/mealtaken/" + mealId;
                    return [2 /*return*/, this.http.put(url, payload, httpOptions).toPromise()];
                });
            });
        };
        UserRoutineResource.prototype.getGroceries = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var fiterparam, res, routine, newgroceriesDict;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fiterparam = new i1$1.HttpParams().set('filters', JSON.stringify(this.getFilersArray()));
                            return [4 /*yield*/, this.http.get(this.config.API_URL + "/users/" + id + "/routines", { params: fiterparam }).toPromise()];
                        case 1:
                            res = _a.sent();
                            routine = res.data;
                            newgroceriesDict = {};
        ...
        UserRoutineResource.prototype.getFilersArray = function () {
            var today = moment__default["default"]().format("YYYYMMDD");
            var filersArray = [
                {
                    "field": "date",
        ...
        return UserRoutineResource;
    }());
    UserRoutineResource.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserRoutineResource, deps: [{ token: ngxFiteloConfig }, { token: i1__namespace$1.HttpClient }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    UserRoutineResource.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserRoutineResource, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserRoutineResource, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    var CustomOptionsResource = /** @class */ (function () {
        ...
        CustomOptionsResource.prototype.saveAllMedicalCondtions = function (medicalConditions) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.firestore.doc('customOptions/medicalConditions').set({ value: medicalConditions })];
                });
            });
        };
    ...
    var PushNotificationsResource = /** @class */ (function () {
        function PushNotificationsResource(firestore) {
            this.firestore = firestore;
        }
        PushNotificationsResource.prototype.getAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.firestore.collection('pushNotifications', function (q) { return q.orderBy('timestamp', 'desc'); }).get().toPromise()];
                        case 1: return [2 /*return*/, (_a.sent()).docs.map(function (d) { return d.data(); })];
                    }
                });
            });
        };
    ...
    PushNotificationsResource.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PushNotificationsResource, deps: [{ token: i1__namespace.AngularFirestore }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    PushNotificationsResource.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PushNotificationsResource, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PushNotificationsResource, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    var UsersPaymentResource = /** @class */ (function () {
        ...
        UsersPaymentResource.prototype.getUserPayment = function (uid) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.doc(uid).get().toPromise()];
    ...
    var UserNotificationsResource = /** @class */ (function () {
        function UserNotificationsResource(firestore) {
            this.firestore = firestore;
        }
        UserNotificationsResource.prototype.doc = function (uid) {
            return this.firestore.doc("userNotifications/" + uid);
        };
        UserNotificationsResource.prototype.getUserRemindersDict = function (uid) {
            return __awaiter(this, void 0, void 0, function () {
                var un;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, un.remindersDict];
                    }
                });
            });
        };
        UserNotificationsResource.prototype.getUserReminderDict = function (uid, type) {
            return __awaiter(this, void 0, void 0, function () {
                var un;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!un || !un.remindersDict)
                                return [2 /*return*/, null];
                            return [2 /*return*/, type ? un.remindersDict[type + 'ReminderDict'] : un.remindersDict];
                    }
                });
            });
        };
        UserNotificationsResource.prototype.saveUserReminderDict = function (uid, type, reminderDict) {
            return __awaiter(this, void 0, void 0, function () {
                var un;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.doc(uid).set(un)];
                    }
                });
            });
        };
        UserNotificationsResource.prototype.getUserMedicineReminderDict = function (uid, idx) {
            return __awaiter(this, void 0, void 0, function () {
                var un;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!un || !un.remindersDict)
                                return [2 /*return*/, null];
                            return [2 /*return*/, un.remindersDict['medicineReminderDicts'][idx]];
                    }
                });
            });
        };
        UserNotificationsResource.prototype.saveUserMedicineReminder = function (uid, idx, reminderDict) {
            return __awaiter(this, void 0, void 0, function () {
                var un;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    UserNotificationsResource.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserNotificationsResource, deps: [{ token: i1__namespace.AngularFirestore }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    UserNotificationsResource.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserNotificationsResource, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserNotificationsResource, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    var UserGuidelinesResource = /** @class */ (function () {
        function UserGuidelinesResource(afs) {
            this.afs = afs;
        }
        UserGuidelinesResource.prototype.getGuidelines = function (uid) {
            return __awaiter(this, void 0, void 0, function () {
                var data, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.afs.doc("userGuidelines/" + uid).get().toPromise()];
                        case 2:
                            data = (_a.sent()).data();
                            return [3 /*break*/, 4];
                        case 3:
        ...
        return UserGuidelinesResource;
    }());
    UserGuidelinesResource.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserGuidelinesResource, deps: [{ token: i1__namespace.AngularFirestore }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    UserGuidelinesResource.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserGuidelinesResource, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: UserGuidelinesResource, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    var PlansResource = /** @class */ (function () {
        function PlansResource(firestore) {
            this.firestore = firestore;
        }
        PlansResource.prototype.mget = function (planIds) {
            return __awaiter(this, void 0, void 0, function () {
                var dbPlans, plans;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.firestore.collection('plans', function (q) { return q.where('id', 'in', planIds); }).get().toPromise()];
                        case 1:
                            dbPlans = (_a.sent()).docs.map(function (d) { return d.data(); });
                            plans = [];
                            planIds.forEach(function (planId) {
                                plans.push(Object.assign({}, dbPlans.find(function (p) { return p.id == planId; })));
                            });
    ...
    PlansResource.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PlansResource, deps: [{ token: i1__namespace.AngularFirestore }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    PlansResource.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PlansResource, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.7", ngImport: i0__namespace, type: PlansResource, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    var StorageResource = /** @class */ (function () {
        ...
        StorageResource.prototype.uploadUserFile = function (uid, type, file) {
            ...
            var name = file.name ? file.name : type + '-' + Math.random().toString().slice(2);
    ...
    var WordpressResource = /** @class */ (function () {
        ...
        WordpressResource.prototype.getHealthyRecipes = function () {
    ...
    exports.FirestorePlansResource = PlansResource;
    ...
    exports.PlansResource = PlansResource$1;
    exports.PushNotificationsResource = PushNotificationsResource;
    ...
    exports.UserGuidelinesResource = UserGuidelinesResource;
    exports.UserNotificationsResource = UserNotificationsResource;
    exports.UserRoutineResource = UserRoutineResource;
